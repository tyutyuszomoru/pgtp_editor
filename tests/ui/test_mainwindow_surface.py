...
EXPECTED_HOST_SURFACE = {
    ...
    "_enrich_schema_from_file",
    "_ensure_curated_bootstrap",
    "_enter_caption_mode",
    "_export_xsd",
    "_fetch_db_schema",
    "_fetch_ddl_schema",
    ...
    "_history_jump",
    "_import_xsd",
    "_insert_page_before_pages_close",
    ...
    "_on_coherence_toggled",
    "_on_db_create_requested",
    "_on_db_jump_requested",
    "_on_db_rename_requested",
    ...
    "_on_xsd_close_requested",
    "_on_xsd_text_changed",
    ...
    "_project_output_folder_default",
