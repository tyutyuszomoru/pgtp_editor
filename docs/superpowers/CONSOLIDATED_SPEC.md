...
§25, open). After the seed the app never writes it (Import XSD replaces it wholesale, by explicit user
action).
...
**Schema menu — five items** (between Diff/Merge and Tools; see consolidated menu):
